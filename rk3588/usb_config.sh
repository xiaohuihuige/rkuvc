...
configure_uvc_resolution_nv12()
{
  UVC_DISPLAY_W=$1
  UVC_DISPLAY_H=$2
  UVC_DISPLAY_DIR=${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/uncompressed/u2/${UVC_DISPLAY_W}_${UVC_DISPLAY_H}p
  ...
  echo 12 >${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/uncompressed/u2/bBitsPerPixel
  echo -ne \\x4e\\x56\\x31\\x32\\x00\\x00\\x10\\x00\\x80\\x00\\x00\\xaa\\x00\\x38\\x9b\\x71 > ${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/uncompressed/u2/guidFormat
}
...
configure_uvc_resolution_yuyv()
{
    UVC_DISPLAY_W=$1
    UVC_DISPLAY_H=$2
    UVC_DISPLAY_DIR=${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/uncompressed/u1/${UVC_DISPLAY_W}_${UVC_DISPLAY_H}p
    mkdir ${UVC_DISPLAY_DIR}
    echo $UVC_DISPLAY_W > ${UVC_DISPLAY_DIR}/wWidth
    echo $UVC_DISPLAY_H > ${UVC_DISPLAY_DIR}/wHeight
    echo 333333 > ${UVC_DISPLAY_DIR}/dwDefaultFrameInterval
    ...
    echo $((UVC_DISPLAY_W*UVC_DISPLAY_H*2)) > ${UVC_DISPLAY_DIR}/dwMaxVideoFrameBufferSize
    echo -e "333333\n666666\n1000000\n2000000" > ${UVC_DISPLAY_DIR}/dwFrameInterval
	echo 16 > ${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/uncompressed/u1/bBitsPerPixel
    echo -ne \\x59\\x55\\x59\\x32\\x00\\x00\\x10\\x00\\x80\\x00\\x00\\xaa\\x00\\x38\\x9b\\x71 > ${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/uncompressed/u1/guidFormat
}
...
uvc_device_config()
{
  ...
  ##YUYV support config
  mkdir /sys/kernel/config/usb_gadget/rockchip/functions/uvc.gs6/streaming/uncompressed/u1
  ...
  ln -s ${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/uncompressed/u1 ${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/header/h/u1
  ln -s ${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/uncompressed/u2 ${USB_FUNCTIONS_DIR}/uvc.gs6/streaming/header/h/u2
